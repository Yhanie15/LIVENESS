function openModal(imageSrc, score, status, transactionId) {
  console.log("Opening modal with image:", imageSrc, "Score:", score, "Status:", status, "Transaction ID:", transactionId)
  ...
  if (modal && modalImage && imageStatus && scoreValue) {
    ...
    if (status.toLowerCase() === "real") {
      ...
      // Change X to checkmark for real images
