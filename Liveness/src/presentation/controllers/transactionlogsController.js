...
exports.transactionlogs_view = async (req, res) => {
  console.log("Transactionlogs route accessed, user:", req.session.user);
  ...
  try {
    ...
    renderTransactionlogsPage(formattedTransactions, {
  ...
  function renderTransactionlogsPage(transactions, pagination, searchTerm = '') {
    res.render("support/layouts/transactionlogs_page", {
